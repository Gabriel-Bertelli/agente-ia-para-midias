...
export function GoalsView({ data }: { data: any[] }) {
  ...
  const dailyData = useMemo(() =>
    buildDailyChartData(data, goals, availableKeys, chartKpi, start, end, chartBUs),
    [data, goals, availableKeys, chartKpi, start, end, chartBUs]);

  // ── To-Go table ───────────────────────────────────────────────────────────

  const toGoRows = useMemo(() =>
    buildToGoTable(data, goals, availableKeys, start, end, chartBUs, today),
