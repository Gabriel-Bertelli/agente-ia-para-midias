                    ...
                    {shareKeys.map((key, idx) => (
                      <Bar key={key} dataKey={key} stackId="share" fill={SHARE_COLORS[idx % SHARE_COLORS.length]} radius={idx === shareKeys.length - 1 ? [4, 4, 0, 0] : [0, 0, 0, 0]}>
                        <LabelList
                          ...
                          style={{ fill: '#fff', fontSize: 11, fontWeight: 700, textShadow: '0 1px 3px rgba(0,0,0,0.5)' }}
                        />
                      </Bar>
                    ))}
                  </BarChart>
                  ...
                  <ComposedChart data={comparativeData} margin={{ top: 20, right: 20, left: 10, bottom: 30 }}>
                    ...
                    >
                      <LabelList
                        ...
                        style={{ fill: '#00e5a0', fontSize: 11, fontWeight: 600 }}
                      />
                    </Bar>
                    <Line
                      yAxisId="right"
                    ...
                    >
                      <LabelList
                        ...
                        style={{ fill: '#818cf8', fontSize: 11, fontWeight: 700 }}
                      />
                    </Line>
                  </ComposedChart>
                </ResponsiveContainer>
                ...
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={compositionData} margin={{ top: 10, right: 10, left: 0, bottom: 40 }}>
                    ...
                    <Bar dataKey="value" fill="#00e5a0" radius={[4, 4, 0, 0]}>
                      <LabelList dataKey="label" position="top" style={{ fill: '#a0a0bc', fontSize: 11 }} />
                    </Bar>
                  </BarChart>
                </ResponsiveContainer>
              ) : (
